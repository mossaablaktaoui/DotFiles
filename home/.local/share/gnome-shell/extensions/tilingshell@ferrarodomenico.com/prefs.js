 ...
 */
var _a;
var Gtk = Me.imports.gi.prefs.Gtk;
var Adw = Me.imports.gi.prefs.Adw;
var Gio = Me.imports.gi.prefs.Gio;
var GLib = Me.imports.gi.prefs.GLib;
var Gdk = Me.imports.gi.prefs.Gdk;
var GObject = Me.imports.gi.prefs.GObject;
...
var SettingsExport = Me.imports.settings.settingsExport.SettingsExport;
var { gettext: _, ngettext, pgettext } = imports.misc.extensionUtils;
var Config = imports.misc.config;
var debug = logger("prefs");
var RESOURCES_PREFIX = "/org/gnome/Shell/Extensions/tilingshell";

var TilingShellExtensionPreferences = class TilingShellExtensionPreferences extends ExtensionPreferences {
  ...
  _buildEdgeTilingBehaviourRow(currentMode, onModeChange) {
    ...
    if (currentMode === EdgeTilingMode.ADAPTIVE) adaptiveBtn.set_active(true);else
    if (currentMode === EdgeTilingMode.GRANULAR) granularBtn.set_active(true);else
...
var ShortcutSettingButton = (_a = class extends Gtk.Button {
  ...
  _a
), _a);// For GNOME Shell version before 45
function init() {
