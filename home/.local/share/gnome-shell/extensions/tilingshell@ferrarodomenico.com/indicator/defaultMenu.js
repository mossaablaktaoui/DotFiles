...
var getMonitors = Me.imports.utils.ui.getMonitors;
...
var openPrefs = Me.imports.polyfill.openPrefs;
...
var createIconButton = Me.imports.indicator.utils.createIconButton;
var debug = logger("DefaultMenu");
var _LayoutsRow = class _LayoutsRow extends St.BoxLayout {
  _layoutsBox;
  _layoutsButtons;
  _label;
  _monitor;
  ...
  updateMonitorName(showMonitorName, monitorsDetails) {
    if (!showMonitorName) this._label.hide();else
    this._label.show();
