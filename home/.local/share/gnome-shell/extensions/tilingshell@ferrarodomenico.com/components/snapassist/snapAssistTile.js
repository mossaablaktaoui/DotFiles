...
var MIN_RADIUS = 2;
var _SnapAssistTile = class _SnapAssistTile extends TilePreview {
  ...
  constructor(params) {
    ...
    if (isTop || this._gaps.top > 0) borderWidth[St.Side.TOP] *= 2;else
    borderWidth[St.Side.TOP] = Math.floor(borderWidth[St.Side.TOP]);
    if (isRight || this._gaps.right > 0) borderWidth[St.Side.RIGHT] *= 2;else
...
var SnapAssistTile = _SnapAssistTile;