...
var _MasonryLayoutManager = class _MasonryLayoutManager extends Clutter.LayoutManager {
  _rowCount;
  _spacing;
  _maxRowHeight;
  _rowHeight;
  ...
  static computePlacements(children, availableWidth, availableHeight, rowHeight) {
    ...
    for (const child of children) {
      ...
      if (rowWidths[shortestRow] === 0) rowWidths[shortestRow] = width;else
...
var MasonryLayoutManager = _MasonryLayoutManager;