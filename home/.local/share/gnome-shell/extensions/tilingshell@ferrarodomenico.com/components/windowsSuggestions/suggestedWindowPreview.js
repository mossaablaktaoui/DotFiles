...
var Graphene = Me.imports.gi.ext.Graphene;
var Atk = Me.imports.gi.ext.Atk;
var Pango = Me.imports.gi.ext.Pango;
...
var _SuggestedWindowPreview = class _SuggestedWindowPreview extends Shell.WindowPreview {
  _overlayShown;
  _icon;
  _metaWindow;
  _windowActor;
  ...
  setStackAbove(actor) {
    ...
    if (actualAbove === null) parent?.set_child_below_sibling(this, null);else
...
var SuggestedWindowPreview = _SuggestedWindowPreview;